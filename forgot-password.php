...
<head>
  ...
  <title>MAHM- Forgot Password</title>
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <<div class="row">
              <div class="col-lg-6 ">
                <img src="img/marco14.gif" width="500px" height="500px">
              </div>
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <img src="img/marco15.JPG" width="300px" height="200px"><br><br>
                    <h1 class="h4 text-gray-900 mb-2">olvidaste contraseña?</h1>
